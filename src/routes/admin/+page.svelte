<script lang="ts">
    ...
    const adminEntries: AdminEntry[] = [
        ...
        { title: 'Design Studio', group: 'POS layout', description: 'Design till tiles, controls, labels and receipts.', path: '/design', permission: 'open_design', accent: '#0891b2', icon: PanelsTopLeft },
        ...
        { title: 'Orders', group: 'Sales', description: 'Receipts, payments, returns and reprints.', path: '/orders', permission: 'open_orders', accent: '#2563eb', icon: ReceiptText },
        ...
        { title: 'Cash-up Sessions', group: 'Sales', description: 'Open sessions and cash-up history.', path: '/shifts', permission: 'open_reports', alternativePermission: 'end_day_close', accent: '#2563eb', icon: CalendarClock },
        ...
        { title: 'Suppliers', group: 'Stock', description: 'Supplier details for stock receiving.', path: '/suppliers', permission: 'open_suppliers', accent: '#d97706', icon: Truck },
        { title: 'Staff', group: 'Staff', description: 'Staff, PINs, roles and permissions.', path: '/employees', permission: 'open_employees', accent: '#7c3aed', icon: UsersRound },
        { title: 'Tax Rates', group: 'Business', description: 'VAT rates and tax configuration.', path: '/tax-rates', permission: 'open_tax_rates', accent: '#ca8a04', icon: Percent },
