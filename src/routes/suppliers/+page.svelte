...
<MgmtPage title="Suppliers">
    <button slot="actions" class="btn btn-primary" on:click={add}>+ Add Supplier</button>
    <table class="tbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><div class="act-row">
                    <button class="btn-icon act-btn" on:click={() => edit(s)}>✎</button>
                    <button class="btn-icon act-btn danger" on:click={() => del(s.id)}>✕</button>
                </div></td>
            </tr>
            {/each}
